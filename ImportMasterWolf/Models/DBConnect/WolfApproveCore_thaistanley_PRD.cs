...
{
    public class WolfApproveCore_thaistanley_PRD : DbContext
    {
        public WolfApproveCore_thaistanley_PRD(DbContextOptions<WolfApproveCore_thaistanley_PRD> options) : base(options)
        { }
